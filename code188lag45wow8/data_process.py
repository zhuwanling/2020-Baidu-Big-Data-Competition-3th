...
#    print(df)
    ...
    # df1 =  create_logging(df1,df,'infectnum_Sum3',1)
    df1 =  create_logging(df1,df,'infectnum_WoW',1)


    for i in range(2,loggingNum+1):
        df1 = create_logging(df1, df, 'infectnum', i)
        # df1 = create_logging(df1, df, 'infectnum_Sum3', i)
        df1 = create_logging(df1, df, 'infectnum_WoW', i)
#    print(df1)
    #生成day_series
