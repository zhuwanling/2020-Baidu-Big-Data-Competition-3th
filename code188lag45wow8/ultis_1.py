...
def submission(train_feature, regressor, df, file,lag_num,log):
    ...
    files = './code188lag45wow8/dataset/data_processed/history_data.csv'
    ...
    col_name = ['infectnum','infectnum_WoW'] #,'infectnum_WoW','infectnum_Sum','migration'
    #lag循环直至lag2
    if lag_num!=1:
    ...
    for i in tqdm(range(30)):
        ...
        #     test_df['infectnum_WoW'] = Wow['infectnum'].copy(deep=True)
        #Sum
        # for k in [4]:
