...
def getdiff(stander,resolute):
    ...
    #对两个数据进行城市融合
    if is_fuse:
        df_stander_choose = ['A','B','C','F','I','J','K']
        df_resolute_choose = ['D','E','G','H']
        ...
        # fuse_resolute.to_csv('./dataset/train_data_all/tempFakeDEGH.csv', index=False, header=None)
    else:
...
if __name__ == "__main__":
    ...
    stander = './dataset/train_data_all/0.931_1.8845lagingDEGH_1.28fake.csv'
#    std_50_01  1.22_GH day000_submission_50_01_  0707_GH
    resolute = './dataset/train_data_all/tempFakeDEGH.csv'
